...
import { desvanecer, deslizarY } from '../../compartido/animaciones';
...
@Component({
  ...
  template: `
    <div class="modal-backdrop" *ngIf="svRapida.estaAbierto()" (click)="svRapida.cerrar()" @desvanecer>
      <div class="modal-content" (click)="$event.stopPropagation()" @deslizarY>
