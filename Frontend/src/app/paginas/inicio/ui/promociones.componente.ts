  ...
  template: `
    <section class="promotions-container">
      ...
      <div class="banners-grid">
        <div class="banner" style="background-image: url('https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=700&auto=format&fit=crop&q=80')" (click)="irADetalle('MON-001')">
        ...
        <div class="banner" style="background-image: url('https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=700&auto=format&fit=crop&q=80')" (click)="irADetalle('TEC-001')">
          <div class="banner-content">
