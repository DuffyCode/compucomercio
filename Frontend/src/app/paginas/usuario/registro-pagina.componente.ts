        ...
        <form (ngSubmit)="alRegistrar()" class="auth-form">
          ...
          <div class="two-col">
            <div class="field-group">
              ...
              <input type="password" [(ngModel)]="form.contrasena" name="contrasena" placeholder="Mínimo 6 caracteres" />
            </div>
            <div class="field-group">
              <label>Confirmar contraseña</label>
              <input type="password" [(ngModel)]="form.confirmar" name="confirmar" placeholder="Repite la contraseña" />
            </div>
          </div>
          ...
          <div class="two-col">
            <div class="field-group">
              <label>Nombre</label>
              <input type="text" [(ngModel)]="form.nombre" name="nombre" placeholder="José" (input)="filtrarSoloLetras($event, 'nombre')" />
            </div>
            <div class="field-group">
              <label>Apellido</label>
              <input type="text" [(ngModel)]="form.apellido" name="apellido" placeholder="García" (input)="filtrarSoloLetras($event, 'apellido')" />
            </div>
          </div>
          <div class="two-col">
            <div class="field-group">
            ...
            <div class="field-group">
              ...
              <input type="tel" [(ngModel)]="form.telefono" name="telefono" placeholder="+1 (555) 000-0000" (input)="filtrarSoloNumeros($event, 'telefono')" />
            </div>
          </div>
          <div class="field-group">
            <label>Género</label>
