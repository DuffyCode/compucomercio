      ...
      <div class="form-card">
        ...
        <form (ngSubmit)="formularioValido() && continuar()" class="card-form">
          <div class="field-group full">
            ...
            <input id="numero" type="text" [(ngModel)]="numero" name="num" 
          ...
          <div class="field-group full">
            ...
            <input id="titular" type="text" [(ngModel)]="titular" name="name" 
          ...
          <div class="two-cols">
            <div class="field-group">
              ...
              <input id="vencimiento" type="text" [(ngModel)]="vencimiento" name="expiry" 
