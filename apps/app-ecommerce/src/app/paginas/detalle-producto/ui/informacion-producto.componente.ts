...
@Component({
    ...
    <div class="product-info-container">
      ...
      <div class="selectors">
        <div class="selector-group">
          <span class="selector-label">Configuración / Variante</span>
  ...
  styles: [`
    ...
    .selector-group .selector-label { display: block; font-size: 0.9rem; font-weight: 800; margin-bottom: 1rem; }
    ...
    .stock-action .selector-label { display: block; font-size: 0.9rem; font-weight: 800; margin-bottom: 1rem; }
